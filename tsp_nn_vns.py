...
# initialize_visited
# ***************************************************
def initialize_visited(dist_matrix):
  count = 0
  visited = []
...
def variable_neighborhood_search(dist_matrix, visited, iterations, max_attempts, neighborhood_size, vertex_cnt, k):
  ...
  # Initialize solution generated by nearest neighborhood algorithm
  initial_solution = generate_initial_solution(dist_matrix, visited, vertex_cnt, k)
  # Copying the initial solution
...
if __name__ == '__main__':
  ...
  count, visited = initialize_visited(distance_matrix_cp)
