...
def general_variable_neighborhood_search(dist_matrix, iterations, max_attempts, neighborhood_size, k):
  ...
  while count < iterations:
    ...
    random_neighborhood = random.sample(range(len(neighborhood_structures)),1)
   
    neighborhood_struct = neighborhood_structures[random_neighborhood[0]]
...
if __name__ == '__main__':
  ...
  k = count  # Subset of k cities of n cities total
  iterations = 100
  max_attempts = 20
  neighborhood_size = 2
